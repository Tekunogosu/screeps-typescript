...
export class RoleBuilder extends Creep {
    ...
    private searchAgrs: Search = {
        ...
        order: [STRUCTURE_EXTENSION, STRUCTURE_TOWER, STRUCTURE_LINK, STRUCTURE_STORAGE, STRUCTURE_CONTAINER, STRUCTURE_ROAD, STRUCTURE_EXTRACTOR, STRUCTURE_FACTORY, STRUCTURE_LAB, STRUCTURE_WALL],
